...
for t in range(component_list_index_start, component_list_index_end):
    ...
    if(names.sliced_selection.find('y') == -1):
        ...
        fits_png(names.save_path[analysis], names.results_path, name_file,cash_stats[-1],psr_factor, tname + 'slice' + str(names.nb_of_slice) + '_PA','all_n', component,'n')
        fits_png(names.save_path[analysis], names.results_path, name_file, cash_stats[-1], psr_factor,tname + 'slice' + str(names.nb_of_slice) + '_PA', 'all_n', component, 'y')
        fits_png(names.save_path[analysis], names.results_path, name_file, cash_stats[-1], psr_factor, tname + 'slice' + str(names.nb_of_slice) + '_PA', 'all_y', component, 'n')
        fits_png(names.save_path[analysis], names.results_path, name_file, cash_stats[-1], psr_factor, tname + 'slice' + str(names.nb_of_slice) + '_PA', 'all_y', component, 'y')
